...
export default function LifePage() {
  ...
  return (
    <main className="page-bg relative min-h-screen overflow-hidden bg-[#050505] text-white">
      ...
      {/* Decorative glows — 粉调，呼应"生活" */}
      <div className="pointer-events-none absolute right-0 top-0 h-[500px] w-[500px] -translate-y-1/4 translate-x-1/3 rounded-full bg-rose-500/[0.06] blur-3xl" />
      <div className="pointer-events-none absolute bottom-1/3 left-0 h-[350px] w-[350px] -translate-x-1/3 rounded-full bg-pink-500/[0.05] blur-3xl" />
